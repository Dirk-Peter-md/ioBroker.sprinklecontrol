 ...
 * @param {{methodControlSM:string, triggerSM:string, analogZPct:string, analogOHPct:string, maxSoilMoistureIrrigation: string}}res - Objekt mit den Ventildaten aus der Config
 ...
 * @returns {{setMetConSM: string, setPct: (number), setAnalogZPct: (number|null), setAnalogOHPct: (number|null), setTrigSM: (string|null), setVal: (number|null)}}
 */
