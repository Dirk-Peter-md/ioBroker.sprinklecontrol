...
/**
 * ConfigObjekt aller Sprinkler
 * 
 * @typedef {Objekt} SprinkleConfig
 * @property {{boolean}[]} startFixDay - 0(Sun); 1(Mon); 2(Tue); 3(Wed); 4(Thur); 5(Fri); 6(Sat)
 * @property {string} startDay - threeRd (jeden 3.Tage) / twoNd (jeden 2.Tag) / fixDay festen Tag
 * @property {boolean} enabled - 
 * @property {boolean} booster - true max. Pumpenleistung alle anderen Ventile werden für 30s deaktiviert
 * @property {boolean} endIrrigation - true => nach der Bewässerung auf 100 % setzen
 * @property {boolean} autoOn - Automatischer Start nach Zeitplan
 * @property {string} autoOnID - sprinklecontrol.0.sprinkle.Rasenumrandung.autoOnID
 * @property {string} objectName - z.B. Rasenumrandung
 * @property {string} objectID - sprinklecontrol.0.sprinkle.Rasenumrandung.runningTime 
 * @property {string} idState - "hm-rpc.0.MEQ1234567.3.STATE"
 * @property {string} updateStateTimerID
 * @property {string} sprinkleID - ID des Sprinklers === pos. im Array
 * @property {string} wateringTime - Zeit für Hauptbewässerung, wird gelöscht wenn Rückmeldung erfolgte
 * @property {string} wateringAdd - Zeit für Zusatzbewässerung
 * @property {string} wateringInterval - Ein / Aus Intervall
 * @property {string} addWateringTime - ...min Zusatzbewässerung bei hohen Temperaturen 
 * @property {number} pipeFlow - Wasserverbrauch des sprinkler-Kreises
 * @property {string} methodControlSM - Art der Kontrolle der Bodenfeuchte ('calculation'; 'bistable'; 'analog'; fixDay) 
 * @property {string} triggerSM - Sensor für die Bodenfeuchte
 * @property {string} inGreenhouse - keine Wettervorhersage verwenden (Gewächshaus)
 * @property {string} analogZPct - analoger Sensor Wert bei 0% (analog zero percent) 
 * @property {string} analogOHPct - analoger Sensor Wert bei 100% (analog one hundert percent)
 * @property {object} soilMoisture
 * @property {number} soilMoisture.val - Bodenfeuchte / Wassergehalt der oberen Bodenschicht (zB. 5 mm == 50%)
 * @property {number} soilMoisture.pct - Bodenfeuchte in % zB. 50% = maxSoilMoistureIrrigation) / 2
 * @property {boolean} soilMoisture.bool - Bodenfeuchtezustand trocken/feucht === true/false
 * @property {number} soilMoisture.min - (zB. 0,02 mm)
 * @property {number} soilMoisture.maxIrrigation - (zB. 10 mm)
 * @property {number} soilMoisture.maxRain - (zB. 12 mm)
 * @property {number} soilMoisture.triggersIrrigation - (zB. 50 % ==> 5 mm)
 * @property {number} soilMoisture.pctTriggerIrrigation - Auslöser der Bewässerung in % (zB. 50%) 
 * @property {object} soilMoisture.pctAddTriggersIrrigation - Auslöser für zusatzbewässerung in % (zB. 75%)
 */
