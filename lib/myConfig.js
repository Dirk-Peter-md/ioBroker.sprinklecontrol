...
const myConfig = {
        ...
        if (result) {
            for (const res of result) {
                ...
                const newEntry = {
                    ...
                    /** @type {number}  */ addWateringTime: ((60 * parseInt(res.addWateringTime)) || 0),                                                    // Zusatzbewässerung bei hohen Temperaturen
    ...
    postponeByOneDay: async (mySprinkleID) => {
        adapter.log.info(`function postponeByOneDay id: ${mySprinkleID}, startDay === ${myConfig.config[mySprinkleID].startDay}`);
