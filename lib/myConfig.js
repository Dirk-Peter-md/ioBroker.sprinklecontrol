...
const myConfig = {
    ...
    setSoilMoistBool: (mySprinkleID, newVal) => {
        if (myConfig.config[mySprinkleID].methodControlSM === 'bistable') {
            adapter.log.info('setSoilMoistBool, ' + myConfig.config[mySprinkleID].objectName + ' => bistable, newVal: ' + newVal);
            if (typeof newVal === "boolean") {
                ...
                adapter.log.info('setSoilMoistPct - bistable: ' + myConfig.config[mySprinkleID].objectName + ' .bool: ' + myConfig.config[mySprinkleID].soilMoisture.bool);
            } else {
