...
function extraTerStr () { // latitude Breitengrad
    ...
    let lowerTrend = trend(ExtraTerStrTab.Tag[currentMonth], ExtraTerStrTab.Tag[followMonth], ExtraTerStrTab[lowerLatitude.toString()][currentMonth], ExtraTerStrTab[lowerLatitude.toString()][followMonth], dayNr);
    let upperTrend = trend(ExtraTerStrTab.Tag[currentMonth], ExtraTerStrTab.Tag[followMonth], ExtraTerStrTab[upperLatitude.toString()][currentMonth], ExtraTerStrTab[upperLatitude.toString()][followMonth], dayNr);

    toDayExtraTerStr = trend(lowerLatitude, upperLatitude, lowerTrend, upperTrend, parseInt(adapter.config.latitude));
}
