...
function extraTerStr () { // latitude Breitengrad
    ...
    adapter.log.info('dayNr: ' + dayNr + ' (' + typeof dayNr + '), lowerLatitude: ' + lowerLatitude + ' (' + typeof lowerLatitude + '), upperLatitude: ' + upperLatitude + ' (' + typeof upperLatitude + '), currentMonth: ' + currentMonth + ' (' + typeof currentMonth + '), followMonth: ' + followMonth + ' (' + typeof followMonth + ')');
    ...
    adapter.log.info('curExtraTerStr: ' + toDayExtraTerStr);
}
...
/**
 * externe Funktionen
 * @type {{setCurTemperature: evaporation.setCurTemperature, setCurIllumination: evaporation.setCurIllumination, initEvaporation: evaporation.initEvaporation, setCurAmountOfRain: evaporation.setCurAmountOfRain, setNewDay: evaporation.setNewDay, setCurHumidity: evaporation.setCurHumidity, setCurWindSpeed: evaporation.setCurWindSpeed, setExtraTerStr: evaporation.setExtraTerStr, setETpTodayNum: evaporation.setETpTodayNum}}
 */
const evaporation = {
    /**
