...
function extraTerStr () { // latitude Breitengrad
    ...
    let lowerTrend = trend(ExtraTerStrTab.Tag[currentMonth], ExtraTerStrTab.Tag[followMonth], ExtraTerStrTab[lowerLatitude][currentMonth], ExtraTerStrTab[lowerLatitude][followMonth], dayNr);
    let upperTrend = trend(ExtraTerStrTab.Tag[currentMonth], ExtraTerStrTab.Tag[followMonth], ExtraTerStrTab[upperLatitude][currentMonth], ExtraTerStrTab[upperLatitude][followMonth], dayNr);
