...
const valveControl = {
     ...
     *
     * @param sprinkleList  //{Array.<{auto: boolean, sprinkleID: number, wateringTime: number}>}
     */
        ...
        for (const res of sprinkleList) {
            ...
            if (!addDone) {
                ...
                const newThread = {};
                    ...
                    newThread.enabled = false;          // Ventil softwaremäßig ein  
                    newThread.enabledState = false;     // Ventil hardwaremäßig ein  
                    ...
                    newThread.onOffTime = myConfig.config[res.sprinkleID].wateringInterval;  
                    newThread.autoOn = res.auto;   
                    newThread.soilMoisture15s = 15 * (myConfig.config[res.sprinkleID].soilMoisture.maxIrrigation - myConfig.config[res.sprinkleID].soilMoisture.triggersIrrigation)
